...
sed -i 's/192.168.1.1/10.128.0.1/g' package/base-files/files/bin/config_generate
...
sed -i 's/OpenWrt /编译时间 $(TZ=UTC-8 date "+%Y.%m.%d") @ Richard /g' package/lean/default-settings/files/zzz-default-settings
...
echo "sed -i '/CPU usage/a\<tr><td width=\"33%\">关于</td><td><a class=\"author-blog\" href=\"https://gitee.com/richardHao\">作者博客</a>&nbsp;&nbsp;&nbsp;<a class=\"author-blog\" href=\"https://github.com/RichardHaoFang/MI-R4A-breed-openwrt\">编译源地址</a>&nbsp;&nbsp;&nbsp;<a class=\"author-blog\" href=\"https://www.bilibili.com\">哔哩哔哩</a></td></tr>' /usr/lib/lua/luci/view/admin_status/index.htm" >> package/lean/default-settings/files/zzz-default-settings
...
# 修改默认wifi名称ssid为fangxin
sed -i 's/ssid=OpenWrt/ssid=fangxing/g' package/kernel/mac80211/files/lib/wifi/mac80211.sh
